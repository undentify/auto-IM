...
5. Кладем все нужные файлы в подпапку "../auto-IM/res". Скрипту нужны следующие файлы: NET_PASSPORT, Кабельный журнал "...Сеть...", Спецификация, файл "RAID", а также файлы lsblk.txt, vm-hw.txt, fstab.txt (опционально вместо этих файлов можно положить архив report.zip в котором присутстсвуют данные файлы).
